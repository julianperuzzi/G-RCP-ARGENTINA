  ...
  return (
    <aside className='animate-fade-in lg:mx-6'>
      ...
      <section id="aprende-rcp" className="px-4 py-4 mx-4 mt-10 bg-zinc-900 text-white">
        ...
        <p className="text-lg mb-4 text-gray-300">Aprende las técnicas de Reanimación Cardiopulmonar (RCP) con nuestros contenido. Geolocaliza todos los DEA de Argentina</p>
