    ...
    <div className="relative flex flex-col items-center justify-center h-screen bg-gradient-to-r from-sky-900 to-sky-400 ">
      ...
      {gameStarted && (
        <>
          ...
          <div className={`text-4xl font-bold px-4 py-2 rounded mb-10 select-none ${feedback === '¡Sigue así, Buen Ritmo!' ? 'bg-green-600' : 'bg-red-500'} text-white transition-opacity duration-300 ease-in-out ${feedback ? 'opacity-100' : 'opacity-0'}`}>
              {feedback}
            </div>
