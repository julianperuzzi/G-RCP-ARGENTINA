...
import imgCertificado from '../assets/img certificacion/Certificados  RCP Company (1).png';
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-5">
          <div className="lg:w-1/2 mb-8 lg:mb-0">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Entrega de Certificación </h2>
